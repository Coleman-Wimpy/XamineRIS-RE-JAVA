...
<body>
    <nav class="flex-nowrap flex-row flex inset-x-0 top-0 z-50 justify-start fixed items-center py-2 px-4 bg-gray-100 ">
        ...
        <a href="/radiologist" class="inline-block py-1 mr-4 text-xl whitespace-nowrap">
            Xamine-RIS
        </a>
    ...
    <form action="/updateImageNotes" method="POST">
        <label>
            <span>Notes: </span>
            <textarea name="imageNotes" id="imageNotes" style="{backgroun-color: gray; color: white}"></textarea>
        </label>
